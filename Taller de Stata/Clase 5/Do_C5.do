...
** 			   						               **
** 	    Clase 5: Manipulación de bases de datos    **
*****************************************************

clear all
set more off, perm
cd "G:\Mi unidad\4_DOCENCIA\Taller de Stata\2020-II\4 - Clases\Clase 5 - Union y compresion de bases de datos"
dir 
*-----------------------------------------*
...
collapse (mean) natdis (sum) pob_total, by(cod_dpto)	
...
export excel "collapse.xlsx", firstrow(variables) sheet("pop_total_stat", replace)
...
gen num_mun2=1
collapse num_mun (max) num_mun1 (sum) num_mun2, by(cod_dpto nom_dpto)
